...
export CHRONOSTRAIN_ECOLI_PAPER_GOLD_STANDARD_JSON="${CHRONOSTRAIN_ECOLI_DB_DIR}/gold_standard_only.json"
export CHRONOSTRAIN_ECOLI_PAPER_GOLD_STANDARD_CLUSTERS="${CHRONOSTRAIN_ECOLI_DB_DIR}/gold_standard_only.clusters.txt"
