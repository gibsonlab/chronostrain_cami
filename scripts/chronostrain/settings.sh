...
export CHRONOSTRAIN_KPNEUMONIAE_GOLD_STANDARD_JSON="${CHRONOSTRAIN_SAUREUS_DB_DIR}/gold_standard_only.json"
export CHRONOSTRAIN_KPNEUMONIAE_GOLD_STANDARD_CLUSTERS="${CHRONOSTRAIN_SAUREUS_DB_DIR}/gold_standard_only.clusters.txt"
