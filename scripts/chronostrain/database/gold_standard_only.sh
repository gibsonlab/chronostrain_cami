...
create_from_seeds "Streptococcus_pneumoniae" "${CHRONOSTRAIN_SAUREUS_DB_DIR}" "${CHRONOSTRAIN_SAUREUS_GOLD_STANDARD_JSON}" "${CHRONOSTRAIN_SAUREUS_GOLD_STANDARD_CLUSTERS}"
create_from_seeds "Klebsiella_pneumoniae" "${CHRONOSTRAIN_SAUREUS_DB_DIR}" "${CHRONOSTRAIN_SAUREUS_GOLD_STANDARD_JSON}" "${CHRONOSTRAIN_SAUREUS_GOLD_STANDARD_CLUSTERS}"
