...
create_from_seeds "Escherichia_coli_paper" "${CHRONOSTRAIN_ECOLI_PAPER_DB_DIR}" "${CHRONOSTRAIN_ECOLI_PAPER_GOLD_STANDARD_JSON}" "${CHRONOSTRAIN_ECOLI_PAPER_GOLD_STANDARD_CLUSTERS}"
...
create_from_seeds "Enterococcus_faecium" "${CHRONOSTRAIN_EFAECIUM_DB_DIR}" "${CHRONOSTRAIN_EFAECIUM_GOLD_STANDARD_JSON}" "${CHRONOSTRAIN_EFAECIUM_GOLD_STANDARD_CLUSTERS}"
