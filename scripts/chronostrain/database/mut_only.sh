...
create_from_seeds() {
  ...
  blast_db_name="CAMI_Strain_Madness_MutOnly"  # Blast DB to create.
...
create_from_seeds "Escherichia_coli" "${CHRONOSTRAIN_ECOLI_DB_DIR}" "${CHRONOSTRAIN_ECOLI_MUT_ONLY_JSON}" "${CHRONOSTRAIN_ECOLI_MUT_ONLY_CLUSTERS}"
create_from_seeds "Escherichia_coli_paper" "${CHRONOSTRAIN_ECOLI_PAPER_DB_DIR}" "${CHRONOSTRAIN_ECOLI_PAPER_MUT_ONLY_JSON}" "${CHRONOSTRAIN_ECOLI_PAPER_MUT_ONLY_CLUSTERS}"
create_from_seeds "Staphylococcus_aureus" "${CHRONOSTRAIN_SAUREUS_DB_DIR}" "${CHRONOSTRAIN_SAUREUS_MUT_ONLY_JSON}" "${CHRONOSTRAIN_SAUREUS_MUT_ONLY_CLUSTERS}"
create_from_seeds "Streptococcus_pneumoniae" "${CHRONOSTRAIN_SPNEUMONIAE_DB_DIR}" "${CHRONOSTRAIN_SPNEUMONIAE_MUT_ONLY_JSON}" "${CHRONOSTRAIN_SPNEUMONIAE_MUT_ONLY_CLUSTERS}"
create_from_seeds "Klebsiella_pneumoniae" "${CHRONOSTRAIN_KPNEUMONIAE_DB_DIR}" "${CHRONOSTRAIN_KPNEUMONIAE_MUT_ONLY_JSON}" "${CHRONOSTRAIN_KPNEUMONIAE_MUT_ONLY_CLUSTERS}"
create_from_seeds "Enterococcus_faecium" "${CHRONOSTRAIN_EFAECIUM_DB_DIR}" "${CHRONOSTRAIN_EFAECIUM_MUT_ONLY_JSON}" "${CHRONOSTRAIN_EFAECIUM_MUT_ONLY_CLUSTERS}"
